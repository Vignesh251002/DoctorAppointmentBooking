...
router.post("/", verifytoken, async (req, res) => {
    try {
        ...
        if (formattedStart < start_time || formattedEnd > end_time) {
        ...
        if(error.code=="23505"){
            if(error.constraint==='unique_appointments')
            message="you already already booked.Please try with different dates"
            statuscode=400
        }
        else{
